...
- 2026-07-14: Prepared the final imported-history branch for a normal merge into the fork main branch. Resolved duplicate-history conflicts in favor of the final implementation and preserved the main-only external provider watcher without force-pushing.
